...
static const char *const yytname[] =
{
  ...
  "ARITH_OP", "RELOP", "BOOLEAN_OP", "IF_WORD", "ELSE_WORD", "WHILE_WORD",
  "FOR_WORD", "INT_WORD", "FLOAT_WORD", "BOOLEAN_WORD", "SEMICOLON",
  "EQUAL", "LEFT_BRACKET", "RIGHT_BRACKET", "LEFT_BRACKET_CURLY",
  "RIGHT_BRACKET_CURLY", "SYSTEM_OUT", "$accept", "goto", 0
};
#endif
